...
class UNet_3Plus_attn_FF_enc_and_dec(nn.Module):
    def __init__(
        self,
        in_channels=3,
        n_classes=1,
        ...
        super(UNet_3Plus_attn_FF_enc_and_dec, self).__init__()
        ...
        #  FF at decoder - BRAIN
        self.ff1_up = ff_parser.Conditioning(128, 320)
        self.ff2_up = ff_parser.Conditioning(64, 320)
        self.ff3_up = ff_parser.Conditioning(32, 320)
        self.ff4_up = ff_parser.Conditioning(16, 320)
        # ------------------
        # initialise weights
